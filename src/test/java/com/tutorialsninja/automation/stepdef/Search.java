...
public class Search {
	...
	HeaderSection deadersection = new HeaderSection();
	...
	public void i_should_see_the_product_in_the_search_resultsil_address()  {
		Assert.assertTrue(Elements.isDisplayed(SearchResultPage.SamsungSyncMaster941BW));
	...
	public void i_should_see_the_page_displaying_the_message(String message)  {
		Assert.assertTrue(Elements.isDisplayed(SearchResultPage.noResultMessage));
